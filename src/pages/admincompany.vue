<template>
  <div>
    ...
    <q-card class="q-mx-auto my-card bg-primary text-white">
      <q-card-section>
        <div class="text-h6">Delivery Companies</div>
        ...
        <q-card-section>
          <div class="text-h6  text-black">Add new company</div>
        </q-card-section>
    ...
    >
      ...
      <q-item v-for="n in items" :key="n.id">
        <q-item-section @click="$router.push('/adminemy12/address/'+n.name)">
          {{n.name}}
        </q-item-section>
        <q-item-section side>
    ...
    <q-dialog v-model="confirm" persistent>
      <q-card>
        <q-card-section class="row items-center">
          <span class="q-ml-sm">Delete company.</span>
        </q-card-section>
